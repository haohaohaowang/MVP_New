package com.wwh.mylibrary.widget;
...
public class RunCruleViewPager extends ViewGroup {
    private static final String TAG = RunCruleViewPager.class.getName();
    ...
    public RunCruleViewPager(Context context) {
    ...
    public RunCruleViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
...
//            mAdapter.unregisterDataSetObserver(mObserver);
    ...
    void populate() {
        ...
        try {
            ...
            LoggerUtils.d(TAG," mAdapter.finishUpdate.error="+e.toString());
        }
        if (hasFocus()) {
